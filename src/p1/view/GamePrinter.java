...
public class GamePrinter {
	...
	private static final String CELL_BORDER_CHAR = "_"; //cambiar por barra media "─"
	...
	public String toString() {
		...
		System.out.println(Messages.NUMBER_OF_CYCLES + " " + game.getCiclo());
		System.out.println(Messages.NUMBER_OF_COINS + " " + game.getSuns());
		System.out.println(Messages.REMAINING_ZOMBIES + " " + game.remainZombies() );
