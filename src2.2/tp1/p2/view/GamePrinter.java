...
public class GamePrinter {
	...
	public String toString() {
		...
		str.append(getInfo());
		str.append(Messages.NUMBER_OF_CYCLES + " " + game.getCycle() + '\n');
		str.append(Messages.NUMBER_OF_COINS + " " + game.getSuncoins()+ '\n');
		str.append(Messages.REMAINING_ZOMBIES + " " + game.getRemainingZombies()+ '\n');
		str.append(Messages.GENERATED_SUNS + " " + game.getGeneratedSuns()+ '\n');
		str.append(Messages.CAUGHT_SUNS + " " + game.getCaughtSuns()+ '\n');
		// Cols numbering
	...
	public String endMessage() {
		if(game.IsPlayerDead()) {
			System.out.println(Messages.ZOMBIES_WIN);System.out.println();
		}
		else if(game.IsPlayerQuits()) {
			System.out.println( Messages.PLAYER_QUITS);System.out.println();
		}
		else {
			System.out.println( Messages.PLAYER_WINS);System.out.println();
		}
